...
const Signup = () => {
    ...
    const PostData = () =>{
        ...
        if(! /^(?=[a-zA-Z0-9._]{8,20}$)(?!.*[_.]{2})[^_.].*[^_.]$/.test(username)){
            ...
            fetch("https://friends-com-backend.onrender.com/signup",{
                method : "post",
                headers : {
...
{/* <h5>You are just One Step away .Signup fast!
                    ...
                    <div className="middle_up">
                        <div className="signup">
                            ...
                            {/* <form> */}
                                <div>
                                    <input className="input_ele" type="text" name="phone" placeholder="Phone no or email address" value={phone} onChange={(e)=>setPhone(e.target.value)} /><br />
                                    <input className="input_ele" type="text" name="name" placeholder="Full Name" value={name} onChange={(e)=>setName(e.target.value)} /><br />
                                    <input className="input_ele" type="text" name="username" placeholder="Username" value={username} onChange={(e)=>setUsername(e.target.value)} /><br />
                                    <input className="input_ele" type="password" name="password" placeholder="Password" value={password} onChange={(e)=>setPassword(e.target.value)} /><br />
                                    <input className="input_ele" type="submit" value="Sign up" onClick={()=>PostData()} />
                                </div>
                            {/* </form> */}
