...
const Home = ()=>{
    ...
    useEffect(()=>{
        fetch('https://friends-com-backend.onrender.com/followingPost', {
            headers:{
    ...
    useEffect(()=>{
        ...
        fetch('https://friends-com-backend.onrender.com/allpost', {
            headers:{
                "Authorization":"Bearer " + localStorage.getItem("jwt")
            }
        }).then(res=> res.json())
    ...
    const likePost = (id)=>{
        fetch('https://friends-com-backend.onrender.com/like', {
            method:"put",
            headers:{
    ...
    const unlikePost = (id)=>{
        fetch('https://friends-com-backend.onrender.com/unlike', {
            method:"put",
            headers:{
                "Content-Type" : "application/json",
                "Authorization" : "Bearer " + localStorage.getItem("jwt")
    ...
    const makeComment = (text, postID)=>{
        fetch('https://friends-com-backend.onrender.com/comment', {
            method:"put",
            headers:{
                "Content-Type" : "application/json",
                "Authorization" : "Bearer " + localStorage.getItem("jwt")
    ...
    const deletePost = (postid)=>{
        ...
        if(window.confirm("Are you sure to delete this post ??")){
            fetch(`https://friends-com-backend.onrender.com/deletepost/${postid}`, {
                method : "delete",
                headers:{
                    Authorization:"Bearer " + localStorage.getItem("jwt")
                }
