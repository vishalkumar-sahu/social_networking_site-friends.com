...
const   ForgetPassword = () => {
    ...
    const sendOTP = () =>{
        fetch("https://friends-com-backend.onrender.com/forgettenPassword",{
            method : "post",
            headers : {
...
{/* <h5>You are just One Step away .Signup fast!
                    ...
                    <div className="middle_up">
                        <div className="signup">
                            ...
                            {/* <form> */}
                                <div>
                                    <input className="input_ele" type="number" maxLength={10} minLength={10} name="phone" placeholder="Enter phone number" value={phone} onChange={(e)=>setphone(e.target.value)} /><br />
