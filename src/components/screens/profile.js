...
const Profile = ()=>{
    ...
    useEffect(()=>{
        ...
        fetch("https://friends-com-backend.onrender.com/mypost",{
            headers : {
    ...
    useEffect(()=>{
        fetch('https://friends-com-backend.onrender.com/bio', {
            headers:{
                "Authorization":"Bearer " + localStorage.getItem("jwt")
            }
        }).then(res=> res.json())
    ...
    const addBio = ()=>{
        ...
        if(addBio != null){
            fetch("https://friends-com-backend.onrender.com/bioset",{
                method : "post",
                headers : {
